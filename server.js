...
mongoose.connect('mongodb+srv://ndivyasree2305:grocerystore@cluster2.8tp2bja.mongodb.net/shopsmart?retryWrites=true&w=majority&appName=Cluster2')
...
// Route to grocery.html (static page)
app.get('/', (req, res) => {
...
app.post('/loginsubmit', async (req, res) => {
  ...
  try {
    ...
    if (isMatch) {
      res.redirect('/grocery.html'); // ✅ Redirect to grocerypage after login
    } else {
